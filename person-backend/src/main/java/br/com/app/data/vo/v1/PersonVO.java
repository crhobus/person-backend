...
@JsonPropertyOrder({ "id", "first_name", "last_name", "address", "gender", "enabled" }) // Ordem dos atributos no JSON de output
public class PersonVO extends RepresentationModel<PersonVO> implements Serializable { // RepresentationModel - suporte a hateoas
    ...
    @JsonProperty("first_name") // Modifica o nome do atributo
    private String firstName;

    @JsonProperty("last_name") // Modifica o nome do atributo
